...
//[max light distance,full light distance,brightness (white tint),intensity,decay (see setLightAttenuation)]
BRPVP_meisterChockOnVehicleDamage = 0.2;
BRPVP_meisterChockOnVehicleDamageRandom = 0.3;
BRPVP_meisterLightData = [1000,10,0.5,6,[1,0,1,0]];
...
BRPVP_deadVehicleSmokeChanceToZeroEffects = 0.1; //Chance de efeitos zero
BRPVP_deadVehicleSmokeTime = [60,80,100]; //Tempo de fumaça do veículo morto
...
BRPVP_maxChange = 1;
BRPVP_chanceToChangeWeather = 0.7; // chance de mudar o clima PADRÃO É 0,5 (50%)
